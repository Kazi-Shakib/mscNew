<?php die("<b><h3><hr><center>Application Time has Expired!</center></b><hr></h3>"); ?>
	<html>
<head>
...
<br /> www.cuet.xyz/msc/consent.php?consent=1&email='.$email.' <br /> Or you may decline the request by clicking the following link:<br /> www.cuet.xyz/msc/consent.php?consent=0&email='.$email.'. If you experience any issues with this link, contact kazishakib98@cuet.ac.bd and please indicate the browser and version you are using. <br /> We very much appreciate your time for your consideration for '.$name.'.
<br />Thank you for your assistance.<br />Sincerely,<br />Postgraduate Admission<br />Chittagong University of Engineering and Technology (CUET)<br />Chittagong-4349, Bangladesh';
